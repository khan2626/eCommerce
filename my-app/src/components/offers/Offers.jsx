...
export default function Offers() {
    return (
        <div className="flex py-5 gap-11 rounded-lg justify-center bg-gradient-to-t  ">
            <div className="offers-left">
                <h1 className="font-bold text-4xl py-4">Exclusive</h1>
                <h1 className="font-bold text-4xl py-3">Offers For You</h1>
