...
export default function ListProducts() {
    ...
    return (
        <div className="place-content-center max-w-auto sm:max-w-4xl mx-auto mt-8 p-2 sm:p-5 bg-gray-300 shadow-lg rounded-lg">
            ...
            {allProducts.map((product, i)=>{
                    return <div key={i} className="flex justify-between py-5 border-2 rounded-lg hover:bg-slate-400">
                        <img className="w-14 object-contain" src={product.image} alt="" />
